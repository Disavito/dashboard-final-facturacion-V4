...
import ResumenDiarioPage from './pages/invoicing/ResumenDiarioPage'; // <-- Importar la nueva página
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<DashboardLayout />}>
        ...
        {/* Sección de Facturación Actualizada */}
        <Route element={<ProtectedRoute resourcePath="/invoicing" />}>
          <Route path="invoicing" element={<InvoicingLayout />}>
            ...
            <Route path="resumen-diario" element={<ResumenDiarioPage />} /> {/* <-- Nueva Ruta */}
